...
public class VisitaPDF {
    ...
    public void generarBoletaPDF() {
        ...
        try {
            ...
            //TAMAÑO DE CELDAS
            float[] ColumnaProducto = new float[]{15f, 30f, 15f, 20f, 20f};
            tablaProducto.setWidths(ColumnaProducto);
            tablaProducto.setHorizontalAlignment(Element.ALIGN_LEFT);
            PdfPCell producto1 = new PdfPCell(new Phrase("Codigo: ", negrita));
            PdfPCell producto2 = new PdfPCell(new Phrase("Nombre Empleado: ", negrita));
            PdfPCell producto3 = new PdfPCell(new Phrase("Nombre Cliente: ", negrita));
            PdfPCell producto4 = new PdfPCell(new Phrase("Fecha: ", negrita));
            PdfPCell producto5 = new PdfPCell(new Phrase("Venta: ", negrita));
